...
class Index:
    ...
    def get_docids_from_postings(self, term, max_doc=192459) -> set():
        """ Use postings and set union to get list of documents containing query words """
        return set([self.searcher.doc(posting.docid).docid() for posting in self.index_reader.get_postings_list(term)])
